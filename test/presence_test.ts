...
// const listByFirst: any = (_id, [first, ..._rest]) => first
...
//     let state: RealtimePresenceState<{ id?: number }> = {
//       u4: [{ id: 4, presence_ref: '4' }],
//     }
...
//       u3: [{ id: 3, presence_ref: '3' }],
//     }
//     const newState: RealtimePresenceState<{ id?: number }> = {
//       u3: [
//         { id: 3, presence_ref: '3' },
//         { id: 3, presence_ref: '3.new' },
//       ],
//     }
//     const joined: [string, object][] = []
//     const left: [string, object][] = []
//     const onJoin = (key, current, newPres) => {
...
//     let state: RealtimePresenceState<{ id?: number }> = fixtures.state()
...
//         leaves: {
//           u1: [{ id: 1, presence_ref: '1' }],
//         } as RealtimePresenceState<{ id: number }>,
//       },
//       () => {},
//       () => {}
//     )
...
//       channelStub as unknown as RealtimeChannel
//     )
...
//     channelStub._trigger('presence_diff', {
//       joins: {},
//       leaves: { u1: user1 },
//     })
//     assert.deepEqual(RealtimePresence.map(presence.state, listByFirst), [
...
//       channelStub as unknown as RealtimeChannel
//     )
//     const onJoins: object[] = []
//     const onLeaves: object[] = []
...
//     channelStub._trigger('presence_state', {
//       u1: user1,
//       u3: user3,
//     })
//     assert.deepEqual(RealtimePresence.map(presence.state, listByFirst), [
